# 📋 Instrucciones Detalladas: Configurar Variables de Entorno en Vercel
...
- [ ] Encontré la sección Environment Variables
- [ ] Configuré `DATABASE_SCHEMA=public` para Production
- [ ] Configuré `DATABASE_SCHEMA=dev` para Preview/Development
- [ ] Hice redeploy de Production
- [ ] Hice redeploy de Preview/Development
- [ ] Esperé a que completaran los redeploys
- [ ] Verifiqué en `/api/debug/schema` (o en logs) que cada entorno usa el schema correcto
