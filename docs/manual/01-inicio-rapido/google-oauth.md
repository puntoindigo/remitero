...
Guía rápida para configurar Google OAuth en localhost o producción.

## Opción A: Solo localhost (Desarrollo)

### Paso 1: Agregar localhost en Google Cloud Console

1. Ve a: https://console.cloud.google.com/apis/credentials
2. Edita tu cliente OAuth "remitero"
3. En "Orígenes autorizados de JavaScript": Agrega `http://localhost:8000`
4. En "URIs de redireccionamiento": Agrega `http://localhost:8000/api/auth/callback/google`
5. Guarda
...
**Para más detalles**: [Configuración Completa de OAuth](../03-autenticacion/google-oauth-setup.md)
