...
export async function GET(request: NextRequest) {
  try {
    ...
    // Calcular remitos por día (últimos 30 días) - solo cantidades totales
    ...
    for (const r of remitosData || []) {
      ...
      // Contar por día (solo total, sin desglose por estado)
    ...
    // Convertir a array ordenado para el gráfico (solo cantidades por día)
