        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex space-x-1">
              ...
              <a href="/clientes" className="px-4 py-2 rounded-md text-sm font-medium bg-white text-gray-900 shadow-sm border border-gray-200">Clientes</a>
      ...
      <div className="mx-auto max-w-3xl p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3 items-end">
            ...
            <Button
              onClick={() => { if (!nombre) return; addCliente(nombre); setNombre(""); }}
              className="h-9 px-4"
            >Guardar</Button>
          </div>
        </div>
                ...
                {db.clientes.map(c => (
                  <tr key={c.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-right text-sm font-medium">
                      <Button variant="outline" size="sm" onClick={() => deleteCliente(c.id)} className="text-red-600 hover:text-red-700">
                        Borrar
                      </Button>
                    </td>
                  </tr>
